...
# now that we collected all arguments, process them
  ...
  if (${_NAME_UPPER}_FOUND)
    ...
    if(FPHSA_CONFIG_MODE)
      ...
      if(NOT VERSION_OK)
        _FPHSA_FAILURE_MESSAGE("${FPHSA_FAIL_MESSAGE}: ${VERSION_MSG} (found ${${_FIRST_REQUIRED_VAR}}). The version of the Python libraries and/or headers does not match that of your 'python' binary (${python_full_path}). Either set your PATH to use a different Python, or set PYTHON_LIBRARY to the full path to the correct version of the Python library and PYTHON_INCLUDE_DIR to the directory containing the corresponding Python.h.")
      else()
