...
function(imp_add_python_tests modulename length type tests)
...
function(imp_add_cpp_tests modulename length output target_list type tests)
  set(modulename ${ARGV0})
  set(length ${ARGV1})
  set(output ${ARGV2})
...
function(imp_add_tests modulename output target_list ttype tests)
  set(modulename ${ARGV0})
  set(output ${ARGV1})
